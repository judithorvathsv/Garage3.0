            ...
            modelBuilder.Entity("Garage3.Models.ParkingEvent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ParkingPlaceId = 1,
                            VehicleId = 1,
                            TimeOfArrival = new DateTime(2021, 9, 12, 16, 7, 43, 194, DateTimeKind.Local).AddTicks(6165)
                        },
                        new
                        {
                            ParkingPlaceId = 2,
                            VehicleId = 2,
                            TimeOfArrival = new DateTime(2021, 9, 8, 16, 7, 43, 197, DateTimeKind.Local).AddTicks(8465)
                        },
                        new
                        {
                            ParkingPlaceId = 3,
                            VehicleId = 3,
                            TimeOfArrival = new DateTime(2021, 9, 11, 16, 7, 43, 197, DateTimeKind.Local).AddTicks(8498)
                        },
                        new
                        {
                            ParkingPlaceId = 4,
                            VehicleId = 15,
                            TimeOfArrival = new DateTime(2021, 9, 6, 16, 7, 43, 197, DateTimeKind.Local).AddTicks(8503)
                        },
                        new
                        {
                            ParkingPlaceId = 5,
                            VehicleId = 16,
                            TimeOfArrival = new DateTime(2021, 9, 10, 16, 7, 43, 197, DateTimeKind.Local).AddTicks(8506)
                        });
                });
