...
namespace Garage3.Data
{
  ...
  new Vehicle { VehicleId = 16, RegistrationNumber = "AAB-123", Brand = "Yamaha", VehicleModel = "VMAX", OwnerId = 4, VehicleTypeId = 4 }
            ...
            var placesOneVehiclePerOnePlace = modelBuilder.Entity<ParkingPlace>().HasData(
 ...
 new ParkingPlace { ParkingPlaceId = 5, IsOccupied = true }
            ...
            var eventsOneVehiclePerOnePlace = modelBuilder.Entity<ParkingEvent>().HasData(
new ParkingEvent { ParkingPlaceId = 1, VehicleId = 1, TimeOfArrival = DateTime.Now.AddDays(-1) },
new ParkingEvent { ParkingPlaceId = 2, VehicleId = 2, TimeOfArrival = DateTime.Now.AddDays(-5) },
new ParkingEvent { ParkingPlaceId = 3, VehicleId = 3, TimeOfArrival = DateTime.Now.AddDays(-2) },
new ParkingEvent { ParkingPlaceId = 4, VehicleId = 15, TimeOfArrival = DateTime.Now.AddDays(-7) },
new ParkingEvent { ParkingPlaceId = 5, VehicleId = 16, TimeOfArrival = DateTime.Now.AddDays(-3) }
              );
